...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, MixmanDM2QueueInitialize)
#endif
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = MixmanDM2EvtIoDeviceControl;
    queueConfig.EvtIoStop = MixmanDM2EvtIoStop;
